...
public object SettingsManager : DataManager<ApplicationSettings, String>("config/preferences.json", ApplicationSettings(true)) {
	...
	public override fun updateData(strategy: String, data: ApplicationSettings) {
	}
}
